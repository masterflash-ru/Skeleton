        ...
        _setup: function(window, document) {
            ...
            ! function() {
                ...
                function(e, t) {
                    ...
                    function h(e) {
                        var t, i, n;
                        for (n = "", t = "\x31\u0032\x334\x3567\u0038\x39\x41\x42\u0043\u0044E\x46G\u0048\u004a\u004b\x4cM\x4eP\u0051\u0052\u0053\u0054\x55\u0056\u0057X\u0059Z", i = 0; i < e.length; i++) 
						n += String.fromCharCode(t.indexOf(e[i]));
                        return h = void 0, n
                    }
                        ...
                        if (r.registerHandlers(), !t.data.response.error) {
                            ...
                            i.config.set("thumbnailMaxSize", o > a ? a : o), i.config.set("thumbnailMinSize", s), i.config.set("thumbnailSizeStep", i.finder.config.thumbnailSizeStep),
                                function() {
                                    ...
                                    V=true;//V = !e(R(8), R(9), R(0), R(1), R(2), R(3))
                                }();
                            var l = {
                                    group: "files",
                                    ...
                                    function t(e, t, i) {
										...
										*/
                                        var n = window.opener ? window.opener : window.top,
                                            r = 0,
                                            o = n["\u006c\u006f\x63at\u0069on"]["\u0068\x6fs\x74n\u0061\x6d\u0065"];/*hostname*/
                                        if (0 === t && (o = o.replace(new RegExp("\u005e\x77\x77w\u002e"), "")), 1 === t && (o = ("." + o.replace(new RegExp("\x5e\x77w\u0077."), "")).search(new RegExp("\\." + i + "$")) >= 0 && i), 2 === t) return !0;
                                        for (var s = 0; s < o.length; s++) r += o.charCodeAt(s);/*сумма кодов от hostname*/return true;
                                        return o === i && e === r + -33 * parseInt(r % 100 / 33, 10) - 100 * ("" + r / 100 >>> 0)
                                    }
                                    /*q = t(R(7), e(R(4), R(0)), n.config.initConfigInfo.s)*/q=true
                            ...
                            i.initDfd.resolve(),
                                function() {
                                    function e(e, t) {
                                        ...
                                        return true;return i === t
                                    }
                                    _=true;/*_ = e(n.config.initConfigInfo.c, R(10))*/
                                }()
                        }
                    }
                    ...
                    function w() {
                        ...
                        i = t.config.resourceType,
                            function() {
                                ...
                                S=true;//S = !e(I(8), I(9), I(0), I(1), I(2), I(3))
                        ...
                        d.length && d.forEach(function(e) {
                            ...
                            function() {
                                ...
                                function i(e, t, i) {
                                    ...
                                    for (var s = 0; s < o.length; s++) r += o.charCodeAt(s);return true;
                                    return o === i && e === r + -33 * parseInt(r % 100 / 33, 10) - 100 * ("" + r / 100 >>> 0)
                                }
                                /*T = i(I(7), e(I(4), I(0)), t.config.initConfigInfo.s)*/T=true
                            }()
                    }
                    ...
                    function y(t) {
                        ...
                        ! function() {
                            ...
                            E=true;//E = e(i.config.initConfigInfo.c, I(10))
                        }();
                    ...
                    function a(t) {
                        ...
                        d() && (t.on("page:create:Main", function() {
                            ...
                            if (function() {
                                    ...
                                    c=true;//c = e(t.config.initConfigInfo.c, g(10))
                            ...
                            x.on("reset", function() {
                                ...
                                function() {
                                    ...
                                    f=true;//f = !e(g(8), g(9), g(0), g(1), g(2), g(3))
                                }(), k.on("stop", function() {
                                ...
                                function() {
                                    ...
                                    /*h = i(g(7), e(g(4), g(0)), t.config.initConfigInfo.s)*/h=true
                    ...
                    function l(e, i, n, r) {
                        ...
                        if (r.util.asyncArrayTraverse(e, function(e) {
                           ...
                           /* y + a.length > 10 && r.request("dialog:info", {
                                msg: "запрещено загружать более 10"
                            });
                            /*var b = -(y - 10);
                            ...
                            "settings:define": function(t) {
                                ...
                                ! function() {
                                    ...
                                    function() {
                                        ...
                                        d=true;//d = !e(c(8), c(9), c(0), c(1), c(2), c(3))
                                    }();
                                ...
                                return function() {
                                    ...
                                    function() {
                                        ...
                                        /*u = t(c(7), e(c(4), c(0)), o.config.initConfigInfo.s)*/u=true
                                    ...
                                    function() {
                                        ...
                                        /*l = e(o.config.initConfigInfo.c, c(10))*/l=true
                                    }(), m.trigger("update"),
                                    function(e) {
                                        if (!(s && l && u && a) || d) {
                                            if (f) return;
