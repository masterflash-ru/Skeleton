<?php
/*[fck_connector_config] => Array
        (
            [Enabled] => 1
            [UserFilesPath] => /
            [UserFilesAbsolutePath] => /usr/home/admin/web/www/
            [FileTypesPath_File] => pic/
            [FileTypesPath_Image] => pic/
            [FileTypesPath_Flash] => pic/
            [FileTypesPath_Media] => pic/
        )*/
session_start();

//if ($_SESSION['fck_connector_config']['UserFilesAbsolutePath']) $baseDir =$_SESSION['fck_connector_config']['UserFilesAbsolutePath'];
	//else $baseDir = resolveUrl($baseUrl) ;
...
if (isset($_SESSION['fck_connector_config']['Enabled']) && $_SESSION['fck_connector_config']['Enabled']) return true;
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => trim($_SESSION['fck_connector_config']['FileTypesPath_File'],"/"),
    'maxSize'           => 0,
...
$config['resourceTypes'][] = array(
    'name'              => 'Images',
    'directory'         =>  trim($_SESSION['fck_connector_config']['FileTypesPath_Image'],"/"),
    'maxSize'           => 0,
